...
import com.garry.zboot.common.vo.IpInfo;
import com.garry.zboot.common.vo.IpLocate;
...
//        }
    ...
    public String getInfo(HttpServletRequest request, String p){
        try {
            String url = request.getRequestURL().toString();
            if(url.contains("127.0.0.1")||url.contains("localhost")){
                return "";
