...
public class QiniuUtil {
     ...
     * 生成上传凭证，然后准备上传
     */
    @Value("${zboot.qiniu.accessKey}")
    private String accessKey;

    @Value("${zboot.qiniu.secretKey}")
    private String secretKey;

    @Value("${zboot.qiniu.bucket}")
    private String bucket;

    @Value("${zboot.qiniu.domain}")
    private String domain;

    @Value("${zboot.qiniu.zone}")
    ...
    public String qiniuUpload(String filePath, String key) {
        ...
        try {
            ...
            throw new ZbootException("上传文件出错，请检查七牛云配置，" + r.toString());
        }
    }
    ...
    public String qiniuBase64Upload(String data64) {
        ...
        try {
            ...
            throw new ZbootException("上传文件出错，请检查七牛云配置，" + e.toString());
        }
        return domain + "/" + key;
    }
