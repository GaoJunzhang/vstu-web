...
import com.garry.zboot.modules.base.service.*;
...
public class UserController {
    ...
    public Result<Object> regist(@ModelAttribute User u,
        ...
        String smcode = redisTemplate.opsForValue().get(u.getMobile())+"";
        if (!smcode.equals(verifyCode)){
            return new ResultUtil<Object>().setErrorMsg("短信验证码无效");
        }
