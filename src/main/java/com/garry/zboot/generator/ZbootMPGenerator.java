...
import static com.garry.zboot.generator.ZbootGenerator.camel2Underline;
import static com.garry.zboot.generator.ZbootGenerator.dotToLine;
import static com.garry.zboot.generator.ZbootGenerator.first2LowerCase;


/**
* class_name: ZbootMPGenerator
* package: com.garry.zboot.generator
* describe: 代码生成器 Mybatis-Plus
* creat_user: ZhangGaoJun@zhanggj@seeyoo.cn
* creat_date: 2019/7/8
* creat_time: 15:53
**/
@Slf4j
public class ZbootMPGenerator {
     ...
     * 建议仅需修改
     */
    private static final String description = "设备资源";
     ...
     * (文件自动生成至该包下)
     */
    private static final String daoPackage = "com.garry.zboot.modules.vstu.dao.mapper";
