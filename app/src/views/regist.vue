<template>
  <Row type="flex" justify="center" align="middle" class="regist" @keydown.enter.native="submitRegist">
    ...
    <Row class="header">
      ...
      <div class="description">注册界面</div>
    </Row>
      ...
      <Form ref="registForm" :model="form" :rules="rules" class="form">
        ...
        <FormItem prop="verifyCode" :error="errorCode">
          <Row type="flex" justify="space-between" class="code-row-bg">
            <Input v-model="form.verifyCode" size="large" clearable placeholder="请输入短信验证码" :maxlength="10" class="input-verify" />
    ...
    <Row class="foot">
      ...
      <Row type="flex" justify="center" class="code-row-bg copyright">
        Copyright © 2018 - Present <a href="#" target="_blank" style="margin:0 5px;">Everyone</a> 版权所有
      </Row>
    </Row>
    </Col>
  </Row>
...
<script>
import { regist, initCaptcha, drawCodeImage,sendSms } from "@/api/index";
