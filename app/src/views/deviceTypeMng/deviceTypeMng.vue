                ...
                <Card>
                    <Row>
                        <Form ref="searchForm" :model="searchForm" inline :label-width="70" class="search-form">
                            ...
                            <span v-if="drop">
                                <Form-item label="状态" prop="isDelete">
                                  <Select
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            getDataList() {
                this.loading = true;
                deviceTypeData(this.searchForm).then(res => {
                    this.loading = false;
                    if (res.success == true) {
            ...
            remove(v) {
                this.$Modal.confirm({
                    ...
                    onOk: () => {
                        delDeviceTypeByIds(v.id).then(res => {
                            if (res.success == true){
                                this.$Message.success("操作成功");
                                this.getDataList();
                            }else {
            ...
            delAll() {
                ...
                this.$Modal.confirm({
                    ...
                    onOk: () => {
                        ...
                        delDeviceTypeByIds(ids).then(res => {
                            if (res.success == true){
                                this.$Message.success("操作成功");
                                this.clearSelectAll();
                                this.getDataList();
