    ...
    <div>
        <div v-show="currNav=='zboot'">
            <Row :gutter="10">
                    ...
                    <Card>
                        ...
                        <div class="to-do-list-con">
                            <Timeline>
                                ...
                                <TimelineItem>
                                    <Icon type="logo-youtube" color="#fb7299" slot="dot"></Icon>
                                    <a href="https://www.bilibili.com/video/av58484547/" target="_blank">项目宣传视频 点我观看
                                                    </a>
                                </TimelineItem>
                             <!--   <TimelineItem>
                ...
                <Col :md="24" :lg="16">
                    <Row :gutter="5">
                        ...
                        <infor-card id-name="user_created_count" :end-val="count.createUser" iconType="md-person-add" color="#2d8cf0" intro-text="用户总数"></infor-card>
                        </Col>
                        <Col :xs="24" :sm="12" :md="8" :style="{marginBottom: '10px'}">
                        <infor-card id-name="visit_count" :end-val="count.visit" iconType="ios-eye" color="#64d572" :iconSize="50" intro-text="设备总数"></infor-card>
                        </Col>
                        <Col :xs="24" :sm="12" :md="8" :style="{marginBottom: '10px'}">
                        <infor-card id-name="collection_count" :end-val="count.collection" iconType="md-cloud-upload" color="#ffd572" intro-text="资源总数"></infor-card>
                        </Col>
                        <!--<Col :xs="24" :sm="12" :md="6" :style="{marginBottom: '10px'}">-->
                        <!--<infor-card id-name="transfer_count" :end-val="count.transfer" iconType="md-shuffle" color="#f25e43" intro-text="当月设备增量"></infor-card>-->
                        <!--</Col>-->
                    </Row>
                    <Row>
                            ...
                            <Card>
                                ...
                                <div style="height:368px;overflow:auto">
                                    <Col :xs="24" :sm="12" :md="12" :style="{marginBottom: '10px'}">
                                        <infor-card id-name="user_created_count" :end-val="count.createUser" iconType="md-person-add" color="#2d8cf0" intro-text="当月设备增量"></infor-card>
                                    </Col>
                                    <Col :xs="24" :sm="12" :md="12" :style="{marginBottom: '10px'}">
                                        <infor-card id-name="visit_count" :end-val="count.visit" iconType="ios-eye" color="#64d572" :iconSize="50" intro-text="当月用户增量"></infor-card>
                                    </Col>
                                    <Col :xs="24" :sm="12" :md="12" :style="{marginBottom: '10px'}">
                                        <infor-card id-name="collection_count" :end-val="count.collection" iconType="md-cloud-upload" color="#ffd572" intro-text="当月资源增量"></infor-card>
                                    </Col>
                                    <Col :xs="24" :sm="12" :md="12" :style="{marginBottom: '10px'}">
                                    <infor-card id-name="transfer_count" :end-val="count.transfer" iconType="md-shuffle" color="#f25e43" intro-text="当月活跃数"></infor-card>
                                    </Col>
                                    <!--<div class="qr">
            ...
            <Modal
              ...
              <iframe src="//player.bilibili.com/player.html?aid=55516007&cid=97064294&page=1" scrolling="no" border="0" frameborder="no" framespacing="0" allowfullscreen="true" style="width:100%;height:550px;"> </iframe>
            </Modal>
        </div>
...
export default {
  ...
  mounted() {
    ...
    var gitalk = new Gitalk({
      clientID: "fb9038da5803748b6e45",
      clientSecret: "5cfe2f9872385a97cc66c4cd386968fba5920763",
      repo: "BluBlog",
      owner: "GaoJunzhang",
      admin: ["GaoJunzhang"],
    ...
    // 宣传视频
    let homeVideo = Boolean(Cookies.get("homeVideo"));
    if (!homeVideo) {
      this.showVideo = true;
      Cookies.set("homeVideo", true);
    }
  }
};
</script>
