                ...
                series: [
                    {
                        ...
                        type: 'bar',
                        data: [
                            {value: 10000, name: 'Mon', itemStyle: {normal: {color: '#2d8cf0'}}},
                            {value: 200000, name: 'Tues', itemStyle: {normal: {color: '#2d8c40'}}},
                            {value: 300000, name: 'Wed', itemStyle: {normal: {color: '#2d6cf0'}}},
                            {value: 1598403, name: 'Thur', itemStyle: {normal: {color: '#5d8cf0'}}},
                            {value: 543250, name: 'Fri', itemStyle: {normal: {color: '#2d8cf0'}}},
                            {value: 1305923, name: 'Sat', itemStyle: {normal: {color: '#fd8cf0'}}},
                            {value: 1103456, name: 'Sun', itemStyle: {normal: {color: '#ad8cf0'}}}
                        ]
                    }
                ]
            };
