...
// 文件上传接口
export const uploadFile = "/zboot/upload/file"
// 验证码渲染图片接口
export const drawCodeImage = "/zboot/common/captcha/draw/"
// 获取菜单
export const getMenuList = "/zboot/permission/getMenuList"
// 获取数据字典
export const getDictData = "/zboot/dictData/getByType/"
...
export const smsLogin = (params) => {
    return postRequest('/sms/login', params)
}
// IP天气信息
...
//获得存储对象
export const ossData = (params) => {
    return getRequest('/common/oss/ossData', params)
}
//删除对象
export const deltetOssObj = (params) => {
    return deleteRequest('/common/oss/delete', params);
}
//批量删除对象
export const deleteOss = (params) => {
    return postRequest('/common/oss/deleteKeys', params);
}

//分页查询
export const pageOssData = (params) => {
    return getRequest('/common/oss/pageOssData', params)
}
...
export const deviceTypeData = (params) => {
    return getRequest('/deviceType/getByPage', params)
}
export const deviceTypeById = (id) => {
    return getRequest(`/deviceType/get/${id}`)
}
export const getAllDeviceType = () => {
    return getRequest(`/deviceType/getAll`)
}
export const addDeviceType = (params) => {
    return postRequest('/deviceType/addDeviceType', params);
}
export const delDeviceTypeByIds = (id) => {
    return deleteRequest(`/deviceType/delByIds/${id}`);
}
/**
 * device
 */
export const deviceData = (params) => {
    return getRequest('/device/getByPage', params)
}
export const deviceById = (id) => {
    return getRequest(`/device/get/${id}`)
}
export const addDevice = (params) => {
    return postRequest('/device/saveOrUpdate', params);
}
