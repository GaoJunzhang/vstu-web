...
;!function (a, b, c) {
    ...
    d = function () {
        function d(d, e) {
            ...
            m = "." + c + (new Date).getTime(), o = a(b), j = a(document), h = a(e.CloseButton, d).first(), n = a(e.TextField, d).first(), g = !1, k = !1, l = function () {
                return a(document.createElement("div")).outerWidth(d.outerWidth(!0)).outerHeight(d.outerHeight(!0)).hide()
            }, f = function () {
                var a;
                d.addClass(e.ActiveClassName).animate({opacity: 1}, 300), g.show(), a = n.data("active-placeholder"), a && (n.data("deactive-placeholder", n.attr("placeholder")), n.attr("placeholder", a)), j.on("keyup" + m, function (a) {
                    var b;
                    return b = a.keyCode || a.which, 27 === b ? i.call(self, a) : void 0
                })
            }, i = function () {
                var a;
                j.off("keyup" + m), n.blur(), a = n.data("deactive-placeholder"), d.animate({opacity: 0}, 200, "swing", function () {
                    return a && n.attr("placeholder", a), g.hide(), d.removeClass(e.ActiveClassName).css("opacity", "")
                })
            }, this.on = function () {
                var b;
                k || (k = !0, b = this, g = l(), d.after(g), n.on("focus" + m, a.proxy(f, this)), h.on("click" + m, a.proxy(i, this)), o.on("scroll" + m, function (a) {
                    return a.preventDefault()
                }))
            }, this.off = function () {
                k && (g.remove(), n.off("focus" + m), h.off("click" + m), j.off("keyup" + m), o.off("scroll" + m), k = !1)
            }
        }
        ...
        var e;
        return e = a.extend(!0, {}, a.fn[c].defaults, b), this.each(function () {
            var b, f;
            return f = a(this), b = f.data(c), b || (b = new d(f, e), f.data(c, b)), b.on()
        })
    }, a.fn[c].defaults = {CloseButton: ".btn-close", TextField: "input[type=text]", ActiveClassName: "active"}
    ...
    $.ajax({
        ...
        success: function (res) {
            ...
            articles.forEach(function (v, k) {
                articleHtml += '<article class="article" id="articleDiv"><header>'
                let imgs = []
                imgs = v.imgs.split(',')
                console.log("我的图片")
                console.log(imgs)
                ...
                articleHtml += '<div class="meta-data">' +
                    ...
                    '                 </div>' +
                    '             </div></header>'
                articleHtml += '<div class="entry-content" id="info">' + v.content + '' + '</div>'
                articleHtml += '<footer>' +
                    '             <ul class="tags">' +
                    '                 <li><a href="#" class="tag" title="阅读">' + v.page + '</a></li>' +
                    '                 <li><a href="#" class="tag" title="点赞">' + v.like + '</a></li>' +
                    '                 <li><a href="#" class="tag">' + v.forward + '</a></li>' +
                ...
                $('.article #info').readmore({
                    speed: 600,
                    moreLink: '<a class="button-text" href="#">开 <span>&darr;</span></a>',
                    lessLink: '<a class="button-text" href="#">合 <span>&uarr;</span></a>',
                    collapsedHeight: 120,
                    heightMargin: 20,
